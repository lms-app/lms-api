 ...
 * @group course
 */
final class AdministratorGetCourseSectionTest extends CourseTestCase
{
    protected string $endpoint = 'api/v1/course/section/%d';

    public function testItGetCourseSection():void
    {
    ...
    public function testItForbidGetCourseSectionWhenUserDoesNotHavePermissions():void
    {
        $entity = Entity::factory()->create(
            [
                'author_id' => $this->getUserForTest()->getAuthorId(),
